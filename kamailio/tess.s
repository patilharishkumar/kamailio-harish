...
#!substdef "!MY_IP_ADDR!172.31.47.187!g"
#!substdef "!MY_DOMAIN!172.31.47.187!g"
...
listen=udp:172.31.47.187:5060
listen=tcp:172.31.47.187:5060
...
alias="ec2-3-109-185-157.ap-south-1.compute.amazonaws.com"
...
#!ifdef WITH_MSRP
# -----  params -- example 2  -----
modparam("msrp", "sipmsg", 0)
modparam("msrp", "cmap_size", 8)
modparam("msrp", "use_path_addr", "msrp.adhoctree.com:9000")
...
event_route[msrp:frame-in] {
	...
	else if($msrp(method)=="AUTH")
	{
		...
		$var(passwd) = "xyz123";
		if(!pv_www_authenticate("myrealm", "$var(passwd)", "0","$msrp(method)"))
		{
			if(auth_get_www_authenticate("myrealm", "1","$var(wauth)"))
			{
